...
const StrategyTipGenerator: React.FC = () => {
    ...
    return (
        <section id={SectionId.ADVISOR} className="py-24 relative bg-lokBlue-900">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-lokGold-900/5 to-transparent"></div>
                    ...
                    <div className="bg-lokBlue-950 border border-slate-800 p-8 md:p-12 relative overflow-hidden">
                        ...
                        <div className="flex flex-col md:flex-row gap-12">
                                ...
                                <div>
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lokGold-600 text-xs uppercase tracking-widest">Advisor AI Core (Gemini 1.5 Flash)</p>
                                        </div>
                                    </div>
                                    <p className="text-slate-400 text-sm leading-relaxed mb-6">
                                        Consult the archives of history. Our Gemini 1.5 Flash advisor synthesizes strategies from thousands of historic battles and political maneuvers.
                                    </p>
                                </div>
                            ...
                            <div className="md:w-2/3 flex flex-col h-full min-h-[300px]">
                                ...
                                {/* Output Screen */}
                                <div className="flex-grow bg-black/60 backdrop-blur-md border border-lokGold-500/20 p-8 mb-6 relative min-h-[200px] flex items-center justify-center shadow-inner">
                                    {/* Inner Corner Accents */}
                                    <div className="absolute top-2 left-2 w-2 h-2 border-t border-l border-lokGold-500/30"></div>
                                    <div className="absolute top-2 right-2 w-2 h-2 border-t border-r border-lokGold-500/30"></div>
                                    <div className="absolute bottom-2 left-2 w-2 h-2 border-b border-l border-lokGold-500/30"></div>
                                    <div className="absolute bottom-2 right-2 w-2 h-2 border-b border-r border-lokGold-500/30"></div>
                                    {!response && !loading && (
