...
export const STATE_INTEL: Record<string, StateData> = {
    ...
    "Madhya Pradesh": {
        ...
        flavorText: "Balance is key. Hold the center to stabilize the flanks.", strategicMoves: ["Tribal Outreach", "Central Rally", "Scheme Rollout"], avatar: "Avaters/.webp"
    },
    "Andhra Pradesh": {
    ...
    "Telangana": {
        ...
        flavorText: "Old traditions meets new money. A complex code to crack.", strategicMoves: ["Digital Welfare", "Pride Campaign", "City-Village Link"], avatar: "Avaters/.webp"
    },
    "Odisha": {
        ...
        flavorText: "Quiet strength endures. Consistency builds an unbreakable base.", strategicMoves: ["Disaster Relief Op", "Women's Self-Help", "Heritage Pride"], avatar: "Avaters/.webp"
    },
    "Jammu and Kashmir": {
        ...
        flavorText: "High risks, legendary rewards. Proving ground for true leaders.", strategicMoves: ["Peace Initiative", "Development Package", "Youth Engagement"], avatar: "Avaters/.webp"
    },
    // Northeast States
    "Assam": {
        ...
        flavorText: "Control Assam to control the Seven Sisters. Win is difficult but not impossible.", strategicMoves: ["Tea Garden Outreach", "Border Security", "Flood Relief"], avatar: "Avaters/.webp"
    },
    "Arunachal Pradesh": {
        ...
        flavorText: "First to greet the dawn. A peaceful yet strategic frontier.", strategicMoves: ["Tribal Welfare", "Infrastructure Push", "Cultural Preservation"], avatar: "Avaters/.webp"
    },
    "Nagaland": {
        ...
        flavorText: "A delicate balance between tradition and integration lies here.", strategicMoves: ["Peace Accord", "Youth Employment", "Heritage Tourism"], avatar: "Avaters/.webp"
    },
    "Manipur": {
        ...
        flavorText: "Ethnic diversity demands masterful diplomacy. Play safely.", strategicMoves: ["Community Dialogue", "Sports Development", "Cultural Festival"], avatar: "Avaters/.webp"
    },
    "Mizoram": {
        ...
        flavorText: "High literacy, high expectations. Policy over promises.", strategicMoves: ["Education Focus", "Environmental Push", "Border Trade"], avatar: "Avaters/.webp"
    },
    "Tripura": {
        ...
        flavorText: "Once red, now shifting. A test of ideological battles here is difficult.", strategicMoves: ["Welfare Schemes", "Youth Startup", "Cross-Border Trade"], avatar: "Avaters/.webp"
    },
    "Meghalaya": {
        ...
        flavorText: "Matrilineal wisdom guides these hills. Tradition is the law.", strategicMoves: ["Mining Policy", "Eco-Tourism", "Matrilineal Heritage"], avatar: "Avaters/.webp"
    },
    ...
    "Haryana": {
        ...
        flavorText: "Farm meets factory. The khap panchayats and 36 Biradaris hold the keys.", strategicMoves: ["Farmer Appeasement", "Industry Pact", "Sports Push"], avatar: "Avaters/.webp"
    },
    "Uttarakhand": {
        ...
        flavorText: "The gods of heaven themselves vote here. Faith is politics.", strategicMoves: ["Temple Restoration", "Char Dham Infra", "Disaster Management"], avatar: "Avaters/.webp"
    },
    "Himachal Pradesh": {
        ...
        flavorText: "Apple orchards and army barracks. Silent but substantial.", strategicMoves: ["Horticulture Boost", "Tourism Drive", "Veterans Care"], avatar: "Avaters/.webp"
    },
    "Goa": {
        ...
        flavorText: "This state is small but strategic. Where defection is an art form.", strategicMoves: ["Casino Politics", "Beach Clean-up", "Heritage Preservation"], avatar: "Avaters/.webp"
    },
    "Chhattisgarh": {
        ...
        flavorText: "Minerals and Maoists. Development vs. disruption.", strategicMoves: ["Tribal Outreach", "Security Ops", "Forest Rights"], avatar: "Avaters/.webp"
    },
    "Jharkhand": {
        ...
        flavorText: "Iron is forged in coal fires in this state. Tribal vs. corporate.", strategicMoves: ["Mining Reform", "Tribal Welfare", "Industrial Pact"], avatar: "Avaters/.webp"
    },
    "Sikkim": {
        ...
        flavorText: "Organic success story. This state is small in size, big in happiness.", strategicMoves: ["Eco-Tourism", "Border Relations", "Youth Skill Development"], avatar: "Avaters/.webp"
    },
    "Ladakh": {
        ...
        flavorText: "Where glaciers meet geopolitics. High altitude, high stakes.", strategicMoves: ["Road Construction", "Border Village Dev", "Tourism Boom"], avatar: "Avaters/.webp"
    },
    "Andaman and Nicobar Islands": {
        ...
        flavorText: "Islands of strategic importance. Gateway to the East.", strategicMoves: ["Naval Expansion", "Eco-Tourism", "Tribal Protection"], avatar: "Avaters/.webp"
    }
};
