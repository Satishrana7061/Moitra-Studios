...
export const STATE_INTEL: Record<string, StateData> = {
    "Rajasthan": {
        ...
        avatar: "Avaters/RAJNATH SINGH.webp"
    },
    "Uttar Pradesh": {
        ...
        avatar: "Avaters/YOGI ADITYANATH.webp"
    },
    "Maharashtra": {
        ...
        avatar: "Avaters/UDDAV THACKREAY.webp"
    },
    "West Bengal": {
        ...
        avatar: "Avaters/MAMTA BENRJEE.webp"
    },
    "Gujarat": {
        ...
        avatar: "Avaters/NARENDRA MODI (PM).webp"
    },
    "Tamil Nadu": {
        ...
        avatar: "Avaters/M K STALIN.webp"
    },
    "Tamilnadu": { // Alias
    ...
    "Karnataka": {
        ...
        avatar: "Avaters/RAHUL GANDHI.webp"
    },
    "Delhi": {
        ...
        avatar: "Avaters/ARVIND KEJRIWAL.webp"
    },
    "Punjab": {
        ...
        avatar: "Avaters/BHAGWANT MANN.webp"
    },
    "Kerala": {
        ...
        avatar: "Avaters/PINARAYI VIJAYAN.webp"
    },
    "Bihar": {
        ...
        avatar: "Avaters/NITISH KUMAR.webp"
    },
    ...
    "Madhya Pradesh": {
        ...
        flavorText: "Balance is key. Hold the center to stabilize the flanks.", strategicMoves: ["Tribal Outreach", "Central Rally", "Scheme Rollout"], avatar: "Avaters/AMIT SHAH.webp"
    },
    "Andhra Pradesh": {
        ...
        flavorText: "Maritime wealth meets political cunning. A vital piece of the puzzle.", strategicMoves: ["Infra-Dev Promise", "Welfare Surge", "Regional Pact"], avatar: "Avaters/N. CHANDRABABU NAIDU.webp"
    },
    "Telangana": {
        ...
        flavorText: "Old traditions meets new money. A complex code to crack.", strategicMoves: ["Digital Welfare", "Pride Campaign", "City-Village Link"], avatar: "Avaters/TEJASWI YADAV.webp"
    },
    "Odisha": {
        ...
        flavorText: "Quiet strength endures. Consistency builds an unbreakable base.", strategicMoves: ["Disaster Relief Op", "Women's Self-Help", "Heritage Pride"], avatar: "Avaters/PRASHANT KISHOR.webp"
    },
    "Jammu and Kashmir": {
        ...
        flavorText: "High risks, legendary rewards. Proving ground for true leaders.", strategicMoves: ["Peace Initiative", "Development Package", "Youth Engagement"], avatar: "Avaters/PRIYANKA GANDHI.webp"
    },
    // Northeast States
    "Assam": {
        ...
        flavorText: "Control Assam to control the Seven Sisters. Win is difficult but not impossible.", strategicMoves: ["Tea Garden Outreach", "Border Security", "Flood Relief"], avatar: "Avaters/AMIT SHAH.webp"
    },
    "Arunachal Pradesh": {
        ...
        flavorText: "First to greet the dawn. A peaceful yet strategic frontier.", strategicMoves: ["Tribal Welfare", "Infrastructure Push", "Cultural Preservation"], avatar: "Avaters/NIRMALA SITHARAMAN.webp"
    },
    "Nagaland": {
        ...
        flavorText: "A delicate balance between tradition and integration lies here.", strategicMoves: ["Peace Accord", "Youth Employment", "Heritage Tourism"], avatar: "Avaters/RAJNATH SINGH.webp"
    },
    "Manipur": {
        ...
        flavorText: "Ethnic diversity demands masterful diplomacy. Play safely.", strategicMoves: ["Community Dialogue", "Sports Development", "Cultural Festival"], avatar: "Avaters/SMRITI IRANI.webp"
    },
    "Mizoram": {
        ...
        flavorText: "High literacy, high expectations. Policy over promises.", strategicMoves: ["Education Focus", "Environmental Push", "Border Trade"], avatar: "Avaters/AKHILESH YADAV.webp"
    },
    "Tripura": {
        ...
        flavorText: "Once red, now shifting. A test of ideological battles here is difficult.", strategicMoves: ["Welfare Schemes", "Youth Startup", "Cross-Border Trade"], avatar: "Avaters/MAYAWATI.webp"
    },
    "Meghalaya": {
        ...
        flavorText: "Matrilineal wisdom guides these hills. Tradition is the law.", strategicMoves: ["Mining Policy", "Eco-Tourism", "Matrilineal Heritage"], avatar: "Avaters/LALU PRASAD YADAV.webp"
    },
    ...
    "Haryana": {
        ...
        flavorText: "Farm meets factory. The khap panchayats and 36 Biradaris hold the keys.", strategicMoves: ["Farmer Appeasement", "Industry Pact", "Sports Push"], avatar: "Avaters/YOGI ADITYANATH.webp"
    },
    "Uttarakhand": {
        ...
        flavorText: "The gods of heaven themselves vote here. Faith is politics.", strategicMoves: ["Temple Restoration", "Char Dham Infra", "Disaster Management"], avatar: "Avaters/NARENDRA MODI (PM).webp"
    },
    "Himachal Pradesh": {
        ...
        flavorText: "Apple orchards and army barracks. Silent but substantial.", strategicMoves: ["Horticulture Boost", "Tourism Drive", "Veterans Care"], avatar: "Avaters/RAHUL GANDHI.webp"
    },
    "Goa": {
        ...
        flavorText: "This state is small but strategic. Where defection is an art form.", strategicMoves: ["Casino Politics", "Beach Clean-up", "Heritage Preservation"], avatar: "Avaters/ARVIND KEJRIWAL.webp"
    },
    "Chhattisgarh": {
        ...
        flavorText: "Minerals and Maoists. Development vs. disruption.", strategicMoves: ["Tribal Outreach", "Security Ops", "Forest Rights"], avatar: "Avaters/BHAGWANT MANN.webp"
    },
    "Jharkhand": {
        ...
        flavorText: "Iron is forged in coal fires in this state. Tribal vs. corporate.", strategicMoves: ["Mining Reform", "Tribal Welfare", "Industrial Pact"], avatar: "Avaters/TEJASWI YADAV.webp"
    },
    "Sikkim": {
        ...
        flavorText: "Organic success story. This state is small in size, big in happiness.", strategicMoves: ["Eco-Tourism", "Border Relations", "Youth Skill Development"], avatar: "Avaters/PINARAYI VIJAYAN.webp"
    },
    "Ladakh": {
        ...
        flavorText: "Where glaciers meet geopolitics. High altitude, high stakes.", strategicMoves: ["Road Construction", "Border Village Dev", "Tourism Boom"], avatar: "Avaters/NITISH KUMAR.webp"
    },
    "Andaman and Nicobar Islands": {
        ...
        flavorText: "Islands of strategic importance. Gateway to the East.", strategicMoves: ["Naval Expansion", "Eco-Tourism", "Tribal Protection"], avatar: "Avaters/PRASHANT KISHOR.webp"
    }
};
...
export const DEFAULT_STATE_DATA: StateData = {
    ...
    avatar: "Avaters/MALLIKARJUN KHARGE.webp"
};
